...
import RegisterInput, {
  registerInput,
} from "../../services/models/RegisterInput";
...
const Register = () => {
  const [executeRequest, { data, loading, error, code }] =
    useApiRequest<RegisterInput>(REGISTER, "POST");
  ...
  }, [username, firstName, lastName, email, password, gender, date]);
  ...
  return (
    <Fragment>
      <div className="flex justify-center pt-32">
        <div className="w-full bg-white rounded-lg shadow dark:border sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700 mb-10">
              ...
              <div className="flex">
                <div className="w-full mr-2">
                  <input
                    ...
                    name="firstname"
                    id="firstname"
                    className="bg-gray-50 border w-full border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
